...
export default function Home() {
  return (
    <main>
        ...
        <p className={styles.text}>Bem-vindo à Clínica Dom da Vida. Estamos preparados para te atender com uma equipe multidisciplinar. Cuidamos da sua saúde e bem-estar em um ambiente acolhedor e moderno. Contamos com uma equipe qualificada para cuidar da sua saúde e bem-estar, cuide da sua saúde com tranquilidade e segurança. Venha conhecer nossa clínica. </p>
